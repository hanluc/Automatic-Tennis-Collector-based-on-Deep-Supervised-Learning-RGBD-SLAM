...
def compute_precision_for_box(box, truth_box, truth_label, threshold=[0.5]):
    ...
    is_single =  not isinstance(threshold, (list, tuple))
    if is_single==True:
        threshold = [threshold,]
...
def run_check_run_length_encode():
    ...
    name = '0c6507d493bf79b2ba248c5cca3d14df8b67328b89efa5f4a32f97a06a88c92c'
    #name = '9facc652efe19f634639585d692a53dd6c2a8e2f0c9baebdfd85b9b41ec58851'  #fix

    npy_file = DATA_DIR + '/image/stage1_train/masks/%s.npy'%name
    ...
    reference_cvs_EncodedPixels =list( df['EncodedPixels'].values)
